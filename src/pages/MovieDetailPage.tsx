...
export default function MovieDetailPage() {
  ...
  const movieUrl = `${API_BASE_URL}/movie/${movieId}?language=ko-KR`;
  const creditsUrl = `${API_BASE_URL}/movie/${movieId}/credits?language=ko-KR`;

  const { data: movie, isPending: isPendingMovie, isError: isErrorMovie } = 
    useCustomFetch<MovieDetail>(movieUrl, API_HEADERS);
  const { data: credits, isPending: isPendingCredits, isError: isErrorCredits } = 
    useCustomFetch<Credits>(creditsUrl, API_HEADERS);

  const isPending = isPendingMovie || isPendingCredits;
